...
export default function Footer1({ ...props }) {
    return (
        <footer
            {...props}
            className={`${props.className} flex flex-col mt-[138px] gap-[60px] py-6 sm:gap-[30px] sm:py-5 bg-button`}
        >
            <div className="container-xs mt-[50px] md:px-5">
                <div>
                    <div className="flex items-start justify-between gap-5 md:flex-col">
                        <div className="flex w-[18%] flex-col gap-4 md:w-full">
                            <div className="mr-2.5 flex flex-col items-start gap-[22px] md:mr-0">
                        ...
                        <div className="flex w-[50%] items-start justify-center self-center md:w-full sm:flex-col">
                            ...
                            <div className="flex w-[54%] items-start justify-between gap-5 self-center sm:w-full">
                                <div className="flex w-[66%] flex-col items-start gap-5 self-center">
                                    <Heading size="title_20px_medium" as="p" className="!text-text-0">
                                        Account
                                    </Heading>
                        ...
                        <div className="mt-1 flex w-[16%] flex-col gap-6 md:w-full">
