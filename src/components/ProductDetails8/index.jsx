...
export default function ProductDetails8({
  newButtonLabel = "NEW",
    ...
    <div {...props} className={`${props.className} flex flex-col items-center w-full gap-3.5`}>
      <div className="relative h-[250px] self-stretch rounded bg-secondary p-3">
        ...
        <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max flex-1 p-[22px] sm:p-5">
          <Img src="images/img_new_mercedes_be.png" alt="Product Image" className="h-[132px] w-[90%] object-contain" />
        </div>
      </div>
      <div className="flex flex-col items-start gap-2 self-stretch">
        ...
        <Img src="images/img_colour_chnage.svg" alt="Color Change Image" className="h-[20px]" />
      </div>
    </div>
  );
}
